...
| <img width="16" height="16" src="https://static.opensuse.org/favicon.ico" /> openSUSE                                                                                                                                                                           | 15.5, 15.6, 16.0, Tumbleweed (滚动)   | 512 MB \* | 5 GB         |
...
- 用户名 `root` 默认密码 `3aZy8GQpnTS25D`，首次开机可能要等几分钟才能成功登录
- 安装最新版可不输入版本号
